<template>
  <div class="lobby d-flex flex-column justify-content-start">
    <!-- TODO: Marquee -->
    ...
    <div class="games-section inflexible d-flex">
      <a href="#" class="d-block rounded bordered flexible">
    ...
    <div class="actions-section inflexible d-flex">
      ...
      <a href="#">
        <img src="/images/create-room.svg" class="rounded-circle bordered d-block">
        <p>创建房间</p>
      </a>
      <a href="#">
